...
import { PUBLIC_CREDENTIALS } from "@/services/auth/authService"
...
export function useLogin() {
  ...
  const form = useForm<LoginValues>({
    ...
    // Precargado con la cuenta pública: basta con pulsar "Iniciar sesión".
    defaultValues: { ...PUBLIC_CREDENTIALS },
    mode: "onTouched",
  })
